...
//above and beyond for lab 1 be sure to implement this by lab 2 or 3
...
void UARTgets(char *buffer, size_t maxLength) {
    ...
    while (1) {
        ...
        if (index < maxLength - 1) {
            ...
            // You might want to clear the buffer or take appropriate action
        }
    }

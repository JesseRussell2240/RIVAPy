...
def send_data():
    random_data = ''.join(str(random.randint(0, 9)) for _ in range(5))  # Generate a random string of 5 numbers
...
if __name__ == "__main__":
    port = serial.Serial("/dev/serial0", 115200, timeout=1)  # Open serial port
